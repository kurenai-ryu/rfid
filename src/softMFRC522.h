/**
 * softMFRC522.h - Library to use ARDUINO RFID MODULE KIT 13.56 MHZ WITH TAGS SPI W AND R BY COOQROBOT.
...
#define MISO_PIN 16    //12      // for uno
#define MOSI_PIN 17    //11      // for uno
#define SCK_PIN  18    //13       // for uno

#ifndef SS_PIN
  #define SS_PIN 19    //10        // for uno
#endif

#ifndef RST_PIN
  #define RST_PIN 0xFF //14       // for uno
#endif
...
public:
	...
	softMFRC522(byte resetPowerDownPin);
	softMFRC522(byte chipSelectPin, byte resetPowerDownPin);
